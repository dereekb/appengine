 ...
 * {@link AppRemoteServiceConfiguration} instances from the
...
public abstract class AbstractRemoteServiceConfigurationGenerator extends AbstractConfigurationFileGenerator {
	...
	public final GenFolderImpl makeConfigurationsForService(AppRemoteServiceConfiguration service) {
	...
	protected boolean shouldMakeConfigurationForService(AppRemoteServiceConfiguration service) {
		return true;
	}

	public GenFolderImpl makeServiceConfiguration(AppRemoteServiceConfiguration service) {
	...
	public void makeServiceConfiguration(GenFolderImpl serviceResultsFolder,
	                                     AppRemoteServiceConfiguration service) {
	 ...
	 */
	public GenFile makeServiceConfigurationFile(AppRemoteServiceConfiguration service)
	...
	public interface RemoteServiceClientConfigurationGenerator {
		...
		public GenFolderImpl makeServiceConfigurations(List<AppRemoteServiceConfiguration> services);
	...
	public class SplitByRemoteServiceClientConfigurationGenerator
		...
		public GenFolderImpl makeServiceConfigurations(List<AppRemoteServiceConfiguration> services) {
			...
			for (AppRemoteServiceConfiguration service : services) {
