...
public class AppSecurityContextServiceEntry extends LoginTokenModelContextServiceEntryImpl<App> {
	...
	public AppSecurityContextServiceEntry(Getter<App> getter, ModelRoleSetLoader<App> rolesLoader) {
		super(AppLinkSystemBuilderEntry.LINK_MODEL_TYPE, ModelKeyType.NUMBER, ModelRoleSetUtility.makeDencoder(
		        CrudModelRole.values(), ChildCrudModelRole.values(), AppModelRole.values()), getter, rolesLoader);
	}
