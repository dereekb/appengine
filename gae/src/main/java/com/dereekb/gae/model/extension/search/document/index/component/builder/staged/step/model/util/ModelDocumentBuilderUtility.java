...
public class ModelDocumentBuilderUtility {
	...
	public static void addId(String id,
		...
		addIdWithFormat("%s", id, builder);
	}

	public static void addIdWithFormat(String format,
	                                   String id,
	                                   Document.Builder builder) {
	...
	public static void addDate(Date date,
	                           Document.Builder builder) {
		addDateWithFormat("%s", date, builder);
	}

	public static void addDateWithFormat(String format,
	                                     Date date,
	                                     Document.Builder builder) {
	...
	public static void addDescriptorInfo(DescribedModel model,
	                              Document.Builder builder) {
		addDescriptorInfoWithFormat("%s", model, builder);
	}

	public static void addDescriptorInfoWithFormat(String format,
