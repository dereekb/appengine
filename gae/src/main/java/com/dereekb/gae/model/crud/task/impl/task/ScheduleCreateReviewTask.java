 ...
 */
public class ScheduleCreateReviewTask<T extends UniqueModel> extends AbstractScheduleReviewTask<T> {

	private static final TaskRequest DEFAULT_TASK_REQUEST = new TaskRequestImpl(TaskQueueEditController.CREATE_PATH,
	        Method.PUT);

	public ScheduleCreateReviewTask(String modelResource, TaskScheduler scheduler) throws URISyntaxException,
