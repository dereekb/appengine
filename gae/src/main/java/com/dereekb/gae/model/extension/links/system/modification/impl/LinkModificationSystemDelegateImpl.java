...
public class LinkModificationSystemDelegateImpl
	...
	private class TestPair {
		...
		public void updateWithExistsMap(CaseInsensitiveMapWithSet<ModelKey> existsMap) {
			...
			// Create Result Info
			LinkModificationPreTestResultInfo resultInfo = new LinkModificationPreTestResultInfoImpl(
			        isMissingPrimaryKey, this.secondaryKeys);
	...
	public LinkModificationSystemEntryInstance makeInstanceForType(String type,
		...
		return entry.makeInstance(config);
	}
