 ...
 * @param <T>
 */
public final class DeleteResponseImpl<T extends UniqueModel> extends AbstractServiceResponse<T>
	...
	public DeleteResponseImpl(AbstractServiceResponse<T> response) {
		super(response);
	}
