 ...
 * applying it's parameters to a DocumentQueryBuilder instance.
 *
 * @author dereekb
 *
 * @param <Q>
...
public interface DocumentSearchQueryFactoryDelegate<Q extends DocumentSearchQuery> {
	...
	/**
	 * Builds into the input {@link DocumentQueryBuilder} using the input query.
	 *
	 * @param base
	 * @param query
	 * @return New {@link DocumentQueryBuilder} containing all applicable
