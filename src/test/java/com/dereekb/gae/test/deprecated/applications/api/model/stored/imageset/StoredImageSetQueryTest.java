...
public class StoredImageSetQueryTest extends ModelQueryTest<StoredImageSet> {
	...
	public void queryImageTest() throws Exception {
		...
		assertTrue(imageASets.containsAll(resultModels));
		assertTrue(imageASets.size() == resultModels.size());
	}
	...
	public void queryImageAndTest() throws Exception {
		...
		assertTrue(imageSets.containsAll(resultModels));
		assertTrue(imageSets.size() == resultModels.size());

		assertTrue(resultModels.containsAll(imageASets));
		assertTrue(resultModels.containsAll(imageBSets));

		assertFalse(imageASets.containsAll(resultModels));
		assertFalse(imageBSets.containsAll(resultModels));
	}
