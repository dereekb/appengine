...
public abstract class AbstractModelConfigurationGenerator extends AbstractConfigurationFileGenerator {
	...
	private boolean ignoreInternalOnly = false;
	...
	public boolean isIgnoreInternalOnly() {
		return this.ignoreInternalOnly;
	}

	public void setIgnoreInternalOnly(boolean ignoreInternalOnly) {
		this.ignoreInternalOnly = ignoreInternalOnly;
	}
	...
	protected boolean shouldMakeLocalModelConfiguration(LocalModelConfiguration modelConfig) {
		return !this.ignoreLocal && (!this.ignoreInternalOnly || !modelConfig.isInternalModelOnly());
	}
	...
	protected List<LocalModelConfiguration> getAllLocalConfigurations(SingleObjectFilter<LocalModelConfiguration> filter) {
		return ListUtility.filter(this.getAllLocalConfigurations(), filter);
	}
