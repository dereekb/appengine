...
import com.dereekb.gae.extras.gen.app.config.project.app.configurer.model.local.iterate.impl.RelatedModelUpdateTaskConfigurer;
...
import com.dereekb.gae.server.auth.model.login.taskqueue.updater.LoginLoginPointerDisableSyncTask;
	...
	private static class LoginIterateControllerConfigurer extends LocalModelIterateControllerConfigurerImpl {
		...
		protected class LoginIterateConfigurerInstance extends IterateConfigurerInstance {
			...
			protected void configurePostUpdateTaskList(SpringBeansXMLListBuilder<?> taskListBuilder) {
				super.configurePostUpdateTaskList(taskListBuilder);

				taskListBuilder.ref(LoginLoginPointerDisableSyncTaskConfigurer.UPDATE_TASK_NAME);
			}
			...
			protected List<IterateConfigurerInstanceTaskEntry> buildTaskEntries() {
				...
				entries.add(new LoginLoginPointerDisableSyncTaskConfigurer());
		...
		/**
		 * Configures a task for the LoginLoginPointerDisableSyncTask.
		 *
		 * @author dereekb
		 */
		public static class LoginLoginPointerDisableSyncTaskConfigurer extends RelatedModelUpdateTaskConfigurer {

			private static final String UPDATER_BEAN_ID = "loginLoginPointerDisableSync";

			// Generated by this type
			private static final String UPDATE_TASK_NAME = UPDATER_BEAN_ID + "Task";

			public LoginLoginPointerDisableSyncTaskConfigurer() {
				super(UPDATER_BEAN_ID);
				this.setAddModelPrefix(false);
			}
			...
			protected void configureTaskBeans(AppConfiguration appConfig,
				...
				builder.bean(UPDATER_BEAN_ID).beanClass(LoginLoginPointerDisableSyncTask.class).c().ref("loginRegistry")
				        .ref("loginPointerRegistry").ref("loginPointerConfiguredUpdater");

				super.configureTaskBeans(appConfig, modelConfig, builder);
			}
