...
public class LinkExtensionApiControllerTest extends ApiApplicationTestContext {
	...
	public void testControllerBean() {
		assertNotNull("Controller was not null.", this.controller);
		// assertNotNull("Controller's Converter was not null.", this.controller.getConverter());
		assertNotNull("Controller's Service was not null.", this.controller.getService());
	}
	...
	public void testLinkingFailure() throws Exception {
		...
		assertTrue(status == HttpServletResponse.SC_GONE);
