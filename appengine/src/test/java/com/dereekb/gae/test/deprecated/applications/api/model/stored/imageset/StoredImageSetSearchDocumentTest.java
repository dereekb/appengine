...
public class StoredImageSetSearchDocumentTest extends ModelSearchDocumentTest<StoredImageSet> {
	...
	public void testSearchIndexFields() {
		...
		assertTrue(names.contains(StoredImageSetDocumentBuilderStep.LABEL_FIELD));
		assertTrue(names.contains(StoredImageSetDocumentBuilderStep.DETAIL_FIELD));
		assertTrue(names.contains(StoredImageSetDocumentBuilderStep.TAGS_FIELD));
	}
