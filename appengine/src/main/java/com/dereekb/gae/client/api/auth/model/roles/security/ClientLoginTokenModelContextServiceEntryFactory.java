package com.dereekb.gae.client.api.auth.model.roles.security;
...
/**
 * Factory for {@link ClientLoginTokenModelContextServiceEntry} values.
 *
 * @author dereekb
 *
 */
public class ClientLoginTokenModelContextServiceEntryFactory {
	...
	public LoginTokenModelContextServiceEntry makeServiceEntry(String modelType,
	                                                           ClientModelRolesService clientModelRolesService) {
		return new ClientLoginTokenModelContextServiceEntryImpl(modelType, clientModelRolesService);
	}
	...
	protected class ClientLoginTokenModelContextServiceEntryImpl extends TypedModelImpl
		...
		private ClientModelRolesService clientModelRolesService;
			...
			private class ClientLoginTokenModelContextLoader {
				...
				private class ClientLoginTokenModelContextLoaderPartition {
					...
					protected ClientModelRolesResponseData performRequest() {
						ApiModelRolesTypedKeysRequest context = ApiModelRolesTypedKeysRequestImpl
						...
						try {
							ClientModelRolesResponseData response = ClientLoginTokenModelContextServiceEntryImpl.this.clientModelRolesService
