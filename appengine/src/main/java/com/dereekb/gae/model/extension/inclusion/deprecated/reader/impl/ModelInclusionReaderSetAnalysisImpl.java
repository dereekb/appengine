...
public class ModelInclusionReaderSetAnalysisImpl<T extends UniqueModel>
	...
	private final InclusionReaderSetAnalysisDelegate<T> delegate;

	public ModelInclusionReaderSetAnalysisImpl(Collection<T> models, InclusionReaderSetAnalysisDelegate<T> delegate) {
		this.models = models;
