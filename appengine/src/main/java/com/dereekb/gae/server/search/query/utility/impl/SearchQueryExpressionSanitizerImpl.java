package com.dereekb.gae.server.search.query.utility.impl;
...
/**
 * {@link SearchQueryExpressionSanitizer} implementation.
 *
 * @author dereekb
 *
 */
public class SearchQueryExpressionSanitizerImpl
        implements SearchQueryExpressionSanitizer {
	...
	public String sanitizeExpression(String query) {
		...
		if (this.allowFunctions == false) {
			...
			sanitized = sanitized.replaceAll(",", ""); // Remove any leftover
			                                           // commas
		} else {
